...
export const messages: Record<string, string> = {
  ...
  'ai.shell.codex_structured_delivery': 'Codex delivery rule: user-facing commentary/progress and the final answer are mirrored to Lark automatically as Markdown cards. Do not repeat ordinary progress or final answers with `botmux send`; reserve `botmux send` for explicit capabilities such as attachments, @mentions, or cross-chat delivery. Tool calls, command output, and internal reasoning are not mirrored.',
  ...
  'ai.followup.codex_structured_delivery': 'Write key stages as user-facing commentary and finish with a final answer; both are mirrored automatically to Lark cards. Do not duplicate ordinary progress/results with `botmux send`, except for attachments, @mentions, or cross-chat delivery.',
